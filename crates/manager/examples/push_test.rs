...
async fn main() -> anyhow::Result<()> {
    ...
    let author = non_exhaustive::non_exhaustive!(Relationship {
        id: Uuid::new_v4(),
        type_: RelationshipType::Author,
        related: None,
        attributes: Some(RelatedAttributes::Author(non_exhaustive::non_exhaustive!(
            AuthorAttributes {
    ...
    let cover = non_exhaustive::non_exhaustive!(Relationship {
        id: Uuid::new_v4(),
        type_: RelationshipType::CoverArt,
        related: None,
        attributes: Some(RelatedAttributes::CoverArt(
            non_exhaustive::non_exhaustive!(CoverAttributes {
    ...
    let my_manga = non_exhaustive::non_exhaustive!(ApiObject<MangaAttributes> {
    id: Uuid::new_v4(),
    ...
    attributes: non_exhaustive::non_exhaustive!(MangaAttributes {
        ...
        alt_titles: vec![HashMap::from([(
            Language::Japanese,
            String::from("VTuberとの出会い"),
        )])],
        ...
        description: HashMap::from([(
            Language::English,
            String::from(
                "For some reason, me #Some Guy# is dating \"Sakachi\", the biggest V-Tuber all over Japan. But we need to keep it a secret to not terminate her V-Tuber career. Follow your lovey-dovey story, it might be worth it to read it.",
            ),
        )]),
        is_locked: false,
        links: None,
        ...
        tags: vec![
            non_exhaustive::non_exhaustive!(ApiObject<TagAttributes> {
                id: Tag::Romance.into(),
                type_: RelationshipType::Tag,
                attributes: non_exhaustive::non_exhaustive!(TagAttributes {
